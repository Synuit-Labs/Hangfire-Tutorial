    ...
    public class OptimizationRequestController : Controller
    {
        ...
        public ActionResult Create(OptimizationRequest newOptimizationRequest)
        {
            if (ModelState.IsValid)
            {
                ...
                RecurringJob.AddOrUpdate(newOptimizationRequest.ID.ToString(), () => _optiEngine.OptimizeDeliveries(newOptimizationRequest.ID), cronType);
        ...
        public ActionResult Edit(OptimizationRequest OptimizationRequestEdit)
        {
            if (ModelState.IsValid)
            {
                ...
                RecurringJob.AddOrUpdate(OptimizationRequestEdit.ID.ToString(), () => _optiEngine.OptimizeDeliveries(OptimizationRequestEdit.ID), cronType);
